...
<body>
<?php
echo '<div style="width:100%;"><table width="100%"><tr><td align="left"><img src="../images/logo.png" border="0" height="70" width="257" /></td><td align="right" valign="top"><a href="../admin.php">Back to Home</a> | <span id="clearLogs"><a href="">Clear Logs</a></span> | <a href="../logout.php">Log Off</a></td></tr></table></div>';
...
echo '<table border="1" width="100%" cellpadding="0" cellspacing="0"><tr><th width="15%">Date/Time</th><th width="15%">User</th><th widht="70%">Event</th></tr></table>';
echo '<div class="logs"><table border="1" width="100%" cellpadding="0" cellspacing="0" class="logTable">';
if($i!=1){
for($t=$i-1;$t>0;$t--){
	if($_GET['user']!=""){
